...
As a creator, these show up in your [Transactions area](https://lbry.tv/$/transactions). Note that because these come in as tips, these will _not_ show in your available balance unless unlocked. You can read more about this in the [Tipping and Supports FAQ](https://lbry.com/faq/tipping). We anticipate more improvements to this process in the near future.
