...
Want to explore a web-based prototype of the new LBRY app design? Head over to [https://design.lbry.com](https://design.lbry.com) to get a preview of what's to come. This page works best on a Desktop but may display correctly in landscape mode on mobile. _Please note: some of the design features like notifications and commenting are still experimental and most likely will not roll out with the first iteration of the re-design as they require additional support from the protocol to work properly._
