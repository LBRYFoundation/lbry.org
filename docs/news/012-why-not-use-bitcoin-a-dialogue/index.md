...
_Thin Node opens up a connection to Full Node, which uses non-trivial amounts of resources to keep a full copy of the blockchain._
...
Full Node: Sure, it's _&lt;insert 8 kb of data&gt;_.
...
Thin Node: Hey User, that was kind of a weird experience. I think the answer is _&lt;insert 8 kb of data&gt;_, but I'm basing that on trusting some random node on the internet.
...
_Thin Node opens up a connection to Full Node, which uses non-trivial amounts of resources to keep a full copy of the LBRY blockchain._
...
Thin Node: It's _&lt;insert hash&gt;_.
