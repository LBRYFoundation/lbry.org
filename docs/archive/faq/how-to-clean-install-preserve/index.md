...
_(Exact steps may vary per distro)_

1. Reboot your PC (this is to ensure that no LBRY processes are running).
2. Uninstall the LBRY application by going to terminal and typing: sudo apt-get remove lbry. Y to confirm _(Ubuntu specific command)_.
...
6. Navigate to the .lbrynet folder and delete all items while leaving the following:
   ...
   3. `lbryfile_info.db` - Downloads and Publishes data.
   4. `blockchainname.db` - Supports downloads data.
7. Install the latest version of LBRY from: [GitHub App Page](https://github.com/lbryio/lbry-desktop/releases "GitHub App Page")
