...
1. By default, LBRY Desktop saves any content you view to disk, see the [explanation below](#disk). You can modify this behavior on the **_Settings_** page.
...
4. To sync balances and preferences across devices, make sure you have **_Syncing_** enabled on the **_Settings_** page.
