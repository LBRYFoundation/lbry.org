...
3. Once the holdings page loads up, click on **Deposit by bank/wire**
4. Click on Wire Transfer and click Get Started.
   ![wire-transfer](https://spee.ch/@lbrysh:6/wire-transfer.jpg)
5. Finish the process and deposit USD into your account.
...
1. Click on `Holdings` from the upper right corner.
   ![holdings](https://spee.ch/@lbrysh:6/holdings.jpg)
2. Once the holdings page loads up, find BTC and click the deposit button.
3. Deposit BTC to your account by sending funds to the address shown.
...
4. Enter how much LBC you want to sell or simply click on the percentage to select the amount you'd like to sell. For example, 50% of your total holdings or 100% of your total holding in LBC.
5. Click on place sell order, and once the order is executed, you'll now see your BTC holdings. You can check this right below the place order button or the holdings page from the upper right screen.
...
7. Type in your 2FA if necessary and you are done, you should see your balance withdrawn from Bittrex to your LBRY account in minutes.
...
\*_Please note that it may take up to 10 minutes for the status to reflect under the deposit status. Bittrex requires 200 confirmations, which can take several hours._
