---
description: Like contributing to digital freedom or making money? Why not both! LBRY is hiring.
outline: deep
---

# Join us

Join the team of Content Freedom!

::: warning
The LBRY Foundation isn't hiring at the moment. Also, LBRY Inc. has pulled the plug, so isn't active anymore.
:::

![Team](https://spee.ch/@lbryteam:6/everyone-apr-2018.jpg)
...
- We value [autonomy, mastery, and purpose](http://blog.deliveringhappiness.com/the-motivation-trifecta-autonomy-mastery-and-purpose).
...
- We are extremely transparent, organizationally flat, and open-minded. There are no pure managers &mdash; everyone's a doer. While you will have clear responsibilities, you're welcome to contribute at any level or area of the company.
- We believe great results come from great people. If you're interested in working [with a team of](/team/) bright, creative, and diligent people, this is the place.
...
- Thinking in tradeoffs. There are few one-sided answers in our work. How well can you navigate the [idea maze](https://cdixon.org/2014/03/16/theres-just-a-tremendous-amount-of-craftsmanship-in-between-a-great-idea-and-a-great-product) of possibilities and competing priorites?
...
- For engineers, someone who appreciates that our CTO would [create this document](https://grin.io/coding-maxims) and then link it in a job posting.
...
| ---------------------------------------------------------------------------------------------------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| [lbrycrd](https://github.com/lbryio/lbrycrd)                                                                     | Blockchain Engineer  | [good first issues](https://github.com/lbryio/lbrycrd/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)      |
| [lbry-sdk (client)](https://github.com/lbryio/lbry-sdk)                                                          | Protocol Engineer    | [good first issues](https://github.com/lbryio/lbry-sdk/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)     |
| [lbry-desktop](https://github.com/lbryio/lbry-desktop)<br>[lbry-android](https://github.com/lbryio/lbry-android) | Application Engineer | [good first issues](https://github.com/lbryio/lbry-desktop/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) |
| [lbrytv](https://github.com/lbryio/lbrytv)<br>[chainquery](https://github.com/lbryio/chainquery)                 | API Engineer         | [good first issues](https://github.com/lbryio/lbrytv/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)       |
...
For questions or problems with a particular issue, please comment directly on the GitHub issue. For setup or environment trouble, open a separate issue or email the contact listed in the project `README`. You can also join `#developers` in [the chat](https://chat.lbry.org) to interact with other community members.
...
Interested in contributing but not ready for commitment? We have a [guide for contributors](https://lbry.tech/contribute) to help you find other ways to get involved. If none of that suits your fancy, join the [Discord chat](https://chat.lbry.org) and we'll help you find something you'll love.

![Team](https://spee.ch/@lbryteam:6/everyone.jpg)
